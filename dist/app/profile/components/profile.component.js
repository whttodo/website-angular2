...
var ProfileComponent = (function () {
    ...
    ProfileComponent.prototype.getProfile = function () {
        ...
        this._profileService.getProfile().then(function (profile) {
            _this.profiledetails.name = profile.name.firstname + " " + " " + profile.name.lastname;
            _this.profiledetails.phone = profile.phone;
            _this.profiledetails.email = profile.email;
            _this.profiledetails.address = profile.address;
            _this.profiledetails.social = profile.social;
